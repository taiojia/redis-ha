...
def usage():
    print 'Usage: sudo python redis_ha_installer_el7.py <master|backup>'

def install_epel():
    run.execute_get_output('rpm', '-ivh', 'http://mirrors.ustc.edu.cn/fedora/epel/7/x86_64/e/epel-release-7-1.noarch.rpm')
